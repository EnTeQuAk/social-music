...
STATICFILES_DIRS = (
    ('coffee', os.path.join(BASE_PATH, 'static', 'coffee')),
    ('css', os.path.join(BASE_PATH, 'static', 'css')),
    ('img', os.path.join(BASE_PATH, 'static', 'img')),
    ('js', os.path.join(BASE_PATH, 'static', 'js')),
    ('js/lib', os.path.join(BASE_PATH, 'static', 'js', 'lib')),
    ('scss', os.path.join(BASE_PATH, 'static', 'scss')),
)
